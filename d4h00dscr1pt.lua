	...
	if input.UserInputType == Enum.UserInputType.Keyboard then
		...
		if input.KeyCode == Enum.KeyCode[getgenv()["Key To Macro Speed"]:upper()] then
			if not toggle then
				...
				game:GetService("Players").LocalPlayer.Character:findFirstChildOfClass'Humanoid':LoadAnimation(game:GetService("ReplicatedStorage"):findFirstChild("ClientAnimations"):findFirstChild("Greet")):Play()
				wait(1.6)
				game:GetService("Players").LocalPlayer.Character:findFirstChildOfClass'Humanoid':LoadAnimation(game:GetService("ReplicatedStorage"):findFirstChild("ClientAnimations"):findFirstChild("Greet")):Stop()
				wait()
				...
				Impostor =
					game:GetService("Players").LocalPlayer.Character:findFirstChildOfClass'Humanoid'.Running:Connect(function()
						game:GetService("Players").LocalPlayer.Character:findFirstChildOfClass'Humanoid':LoadAnimation(game:GetService("ReplicatedStorage"):findFirstChild("ClientAnimations"):findFirstChild("Greet")):Stop()
					end)
				Impostor2 =
